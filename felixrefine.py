...
# ---------------------------------------------------------------------------
# IMPORTANT: everything below this line must remain inside the
# if __name__ == '__main__': guard.
#
# On Windows (and in Spyder), ProcessPoolExecutor uses the 'spawn' start
# method.  Each worker process re-imports this file as a module, so any
# top-level executable code would run again inside every worker, causing
# infinite process spawning.  The guard prevents that.
# ---------------------------------------------------------------------------
